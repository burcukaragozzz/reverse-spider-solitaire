...
export const RulesPage: React.FC = () => {
    ...
    return (
        <PageContainer themeName={themeName}>
            <RulesContainer>
                <Info>
                    Sort cards on the tableau so they are in increasing order, from Ace to King.
                    Once a full sequence of ranks is built, it automatically moves to the foundation
                    (cards cannot be placed on the foundation individually). The game is won once
                ...
                <Rules>
                    ...
                    <Rule>
                        ...
                        order from the fully visible face up card on the pile they are moving to.
                        For example, a 7 8 9 pack may move to a pile with 6, as long as they are all
                        the same suit.
                    </Rule>
                </Rules>
                <Rules>
                ...
                <Rules>
                    ...
                    <Rule>
                        Cards cannot be moved to foundation piles directly. A full increasing suit
                        pack must be made on the tableau, and then that pack will move to the first
